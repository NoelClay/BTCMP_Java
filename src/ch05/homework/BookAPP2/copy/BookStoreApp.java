...
public class BookStoreApp {
	...
	public static void main(String[] args) {
		...
		bookArray[1] = BookService.makeBook("travel", "뉴욕 100배 즐기기", "홍지윤", "대원씨아이", 14400, "978-89-255-8673-1");
		bookArray[2] = BookService.makeBook("travel", "바르셀로나, 지금이 좋아", "정다운", "대원씨아이", 15000, "978-89-991-7580-0");
		bookArray[3] = BookService.makeBook("food", "오늘의 맥주", "이성준", "대원씨아이", 18000, "979-11-92814-04-9");
		bookArray[4] = BookService.makeBook("food", "버번 위스키의 모든 것", "조승원", "대원씨아이", 24000, "979-11-90277-42-6");
